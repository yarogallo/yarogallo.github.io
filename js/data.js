data = (function() {
    return {
        bio: {
            ...
            summary: "Hard way learner web enthusiast who work well independently but loves being part of  a team environment, fast learner and experienced team player with good communication and interpersonal skills.",
        ...
        projects: {
            projects: [{
                ...
                images: ["images/arcade-1x.png", "images/arcade-2x.png"],
                githubRepo: "https://github.com/yarogallo/frontend-nanodegree-arcade-game",
                profolioLink: "projects/arcade-dist/index.html",
                color: "#b3ecff"
            }, {
                ...
                images: ["images/places-1x.png", "images/places-2x.png"],
                githubRepo: "https://github.com/yarogallo/frontend-nanodegree-neighborhood-map",
                profolioLink: "projects/map-dist/index.html",
                color: "#ffcccc"
            }, {
                title: "My Reads.",
                description: "The application allows to categorize books into Currently Reading, Want To Read and Read. Each category represent a bookshelf, users are able to move books between bookshelfs and add new books to any bookshelf.",
                images: ["images/reads-1x.png", "images/reads-2x.png"],
                githubRepo: "https://github.com/yarogallo/myReads",
                profolioLink: "",
                color: "#b3e6b3"
            },
            {
